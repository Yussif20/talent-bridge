...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-600/5 to-purple-600/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-1/3 w-80 h-80 bg-gradient-to-tl from-purple-600/5 to-blue-600/5 rounded-full blur-3xl"></div>

      {/* Floating dots */}
      <div className="absolute top-10 left-10 w-2 h-2 bg-blue-400/20 rounded-full animate-pulse"></div>
      <div className="absolute top-20 right-20 w-3 h-3 bg-purple-400/20 rounded-full animate-pulse delay-500"></div>
      <div className="absolute bottom-20 left-1/3 w-1.5 h-1.5 bg-green-400/20 rounded-full animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
              ...
              <div className="group flex items-start gap-4 justify-center md:justify-start p-4 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300">
                ...
                <div>
                  <a
                    ...
                    className="text-gray-300 text-base hover:text-white transition-colors duration-300 font-medium"
                  >
                    {footer("email")}
                  </a>
        ...
        {/* Enhanced Bottom Bar */}
        <div className="border-t border-gradient-to-r from-gray-800 via-gray-700 to-gray-800 mt-12 pt-8 relative">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8">
              <Link
                href={`/${locale}/privacy`}
                className="group text-gray-300 hover:text-white text-base transition-colors duration-300 relative"
              >
