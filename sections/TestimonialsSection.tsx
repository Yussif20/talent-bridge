    ...
    locale === "ar"
      ? [
          ...
          },
          {
            ...
            role: "اختصاصية نفسية",
            content:
              "من أهم الأدوات التي استخدمتها في مجال تقييم الطلاب ثنائيي الاستثناء. تجمع بين الدقة العلمية وسهولة الاستخدام.",
            rating: 5,
            image: "👩‍⚕️",
          },
        ]
      ...
      <div className="container mx-auto max-w-6xl px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            {locale === "ar"
              ? "تجارب حقيقية من المعلمين والأخصائيين وأولياء الأمور الذين يستخدمون أداتنا لدعم الطلاب ثنائيي الاستثناء"
